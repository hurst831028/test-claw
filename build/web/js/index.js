(function () {
    let config = JSON.parse(`{"resolution":{"designWidth":1080,"designHeight":1920,"alignV":"middle","alignH":"center","backgroundColor":"rgba(77, 77, 77, 1)","scaleMode":"fixedheight","screenMode":"none"},"2D":{"useRetinalCanvas":true,"webGL2D_MeshAllocMaxMem":false,"defaultFont":"resources/font/TitanOne-Regular.ttf","defaultFontSize":16,"FPS":60,"isAntialias":true,"isAlpha":false},"splash":{"fit":"center","enabled":false,"duration":1,"backgroundColor":null},"3D":{"enableDynamicBatch":true,"defaultPhysicsMemory":16,"enableUniformBufferObject":true,"pixelRatio":1,"enableMultiLight":true,"maxLightCount":32,"lightClusterCount":{"x":12,"y":12,"z":12},"maxMorphTargetCount":32},"physics2D":{"allowSleeping":true,"gravity":{"x":0,"y":9.8},"velocityIterations":8,"positionIterations":3,"pixelRatio":50,"debugDraw":false,"drawShape":true,"drawJoint":true,"drawAABB":false,"drawCenterOfMass":false},"physics3D":{"fixedTimeStep":0.016666666666666666,"maxSubSteps":1,"enableCCD":false,"ccdThreshold":0.0001,"ccdSphereRadius":0.0001},"physics3dModule":"laya.bullet","physics2dModule":"laya.box2D","spineVersion":"3.8","stat":false,"vConsole":false,"alertGlobalError":false,"startupScene":"scene/Main.ls","useSafeFileExtensions":true,"pkgs":[{"path":""}]}`);
